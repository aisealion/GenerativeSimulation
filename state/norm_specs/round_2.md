...
Acceptance tests: test_R3_fisher_catch_log PASS, test_R3_fisher_exceeds_threshold PASS
...
Agent experience: {"knows": [], "decides": [], "may_do": [], "may_not_do": [], "remembers": [], "observes": []}
Evidence (verified, not merely claimed):
  - object type community_fish_bank created and registered
...
Agent experience: {"knows": [], "decides": [], "may_do": [], "may_not_do": [], "remembers": [], "observes": []}
Evidence (verified, not merely claimed):
  - object type fish_ledger created and registered
...
Evidence (verified, not merely claimed):
  - visibility policy for fish_ledger entries
